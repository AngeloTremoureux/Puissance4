  ...
  (function () {
    return {
      ...
      testUnit1: function () {
        ...
        return (!verifWin(tailleHorizontale,tailleVerticale,'yellow') && JSON.stringify(verifWin(tailleHorizontale,tailleVerticale,'red')) === JSON.stringify(valeurAttendu))
      },
      testUnit2: function () {
        resetGame()
        ...
        return (!verifWin(tailleHorizontale, tailleVerticale,'red') && JSON.stringify(verifWin(tailleHorizontale, tailleVerticale,'yellow')) === JSON.stringify(valeurAttendu))
      },
      testUnit3: function () {
        resetGame()
      ...
      testUnit4: function () {
        ...
        let tailleHorizontale = game.getPx()
        let tailleVerticale   = game.getPy()
        return (!verifWin(tailleHorizontale, tailleVerticale,'red') && !verifWin(tailleHorizontale, tailleVerticale,'yellow'))
      },
      testUnit5: function () {
        resetGame()
